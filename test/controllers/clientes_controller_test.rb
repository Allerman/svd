...
class ClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente" do
    assert_difference("Cliente.count") do
      post clientes_url, params: { cliente: { name: @cliente.name, phone_number: @cliente.phone_number } }
    end
  ...
  test "should update cliente" do
    patch cliente_url(@cliente), params: { cliente: { name: @cliente.name, phone_number: @cliente.phone_number } }
